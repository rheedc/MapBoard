...
<br>
		...
		<div class="formGroup">
			...
			<div class="detailBox">${VIEW.ulevel}</div>
		</div>
		<div class="formGroup">
			<div class="inputTitle">상태</div>
			<div class="detailBox">${VIEW.status}</div>
		</div>
	
		<div class="formBtn">
			<input type="submit" id="updateBtn" class="actionBtn" value="수정" onclick="memModify('${VIEW.userid}');" />
